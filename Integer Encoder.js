...
globalThis.enc=(a,b,$='0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_!#$%&()*+,-./:;<=>?@[]^{|}~',j,l,t,z,y='',k='length',n=127,f=BigInt,i=f.asUintN,s=f($[k]),p=1n,r=p,u=-p,v=p,[c,d,e,g,h,m,o,q]=b?a.map((a,d,e)=>{d=a[k];e=-p;while(d)e=++e*s+f($.indexOf(a[--d]));return e+p}):Array(8).fill(0n))=>{if(b)for(l=l=>{l=!!i(1,c)<<7|!!i(1,d)<<6|!!i(1,e)<<5|!!i(1,g)<<4|!!i(1,h)<<3|!!i(1,m)<<2|!!i(1,o)<<1|!!i(1,q);c>>=p;d>>=p;e>>=p;g>>=p;h>>=p;m>>=p;o>>=p;q>>=p;return l};q-p;y+=String.fromCodePoint(r>>7?((j=l())>>7&&l())|((r&n)<<7|j&n)<<(j>>7&&7):r))r=l();else{l=a[k];for(b=j=0;l||j;r<<=p){j?j&=j>n&&n:(l--,j=(y=a.codePointAt(b++))>>7)>>9&&(l--,b++);z=j?(j>>7||j)|128:y&n;z>>7?c|=r:0;z&64?d|=r:0;z&32?e|=r:0;z&16?g|=r:0;z&8?h|=r:0;z&4?m|=r:0;z&2?o|=r:0;z&1?q|=r:0}q|=r;if(t=s-p){k=k=>$[Number(b%s)];p=s;a=a=>s<=(b=(a-p+s)/t);[c,d,e,g,h,m,o,q]=([z,i,f,n,l,j,y,r]=[c,d,e,g,h,m,o,q].map(a=>a--?a*t:a)).map(d=>d<0?'':$[(b=(d-p+s)/t)%s]);while(r){p*=s;t*=s;z+v?c+=k(a(z)?0:z=u):0;i+v?d+=k(a(i)?0:i=u):0;f+v?e+=k(a(f)?0:f=u):0;n+v?g+=k(a(n)?0:n=u):0;l+v?h+=k(a(l)?0:l=u):0;j+v?m+=k(a(j)?0:j=u):0;y+v?o+=k(a(y)?0:y=u):0;q+=k(a(r)?0:r=0)}}y=[c,d,e,g,h,m,o,q];t?0:y=y.map(a=>$.repeat([--a]))}return y};
