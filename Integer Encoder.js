...
globalThis.enc=(a,b,$='0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_!#$%&()*+,-./:;<=>?@[]^{|}~',j,l,z,y='',n=127,f=BigInt,i=(a,b,d=p,e=b?-d--:'',g=f($.length),h=g-d)=>{if(e)while(a[d])e=++e*g+f($.indexOf(a[d++]));else if(h?a>=0:![e=$.repeat([++a])])do{e=$[(b=(g-d*g+h*a)/(h*d))%g]+e;d*=g}while(g<=b);return e},p=1n,s=0n,r=p,[c,d,e,g,h,m,o,q]=b?a.map(a=>i(a,1)+p):Array(8).fill(s))=>{if(b)for(i=f.asUintN,l=l=>{l=!!i(1,c)<<7|!!i(1,d)<<6|!!i(1,e)<<5|!!i(1,g)<<4|!!i(1,h)<<3|!!i(1,m)<<2|!!i(1,o)<<1|!!i(1,q);c>>=p;d>>=p;e>>=p;g>>=p;h>>=p;m>>=p;o>>=p;q>>=p;return l};q-p;y+=String.fromCodePoint(r>>7?((j=l())>>7&&l())|((r&n)<<7|j&n)<<(j>>7&&7):r))r=l();else{l=a.length;for(b=j=0;l||j;r<<=p){j?j&=j>n&&n:(l--,j=(y=a.codePointAt(b++))>>7)>>9&&(l--,b++);z=j?(j>>7||j)|128:y&n;c|=z>>7?r:s;d|=z&64?r:s;e|=z&32?r:s;g|=z&16?r:s;h|=z&8?r:s;m|=z&4?r:s;o|=z&2?r:s;q|=z&1?r:s}y=[c,d,e,g,h,m,o,q|r].map(a=>i(--a))}return y};
