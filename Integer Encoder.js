...
globalThis.enc=(a,b,$='0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_!#$%&()*+,-./:;<=>?@[]^{|}~',j,l,z,y='',p='codePointAt',n=127,f=BigInt,i=(a,b,d=1n,e=b?-d--:'',g=f($.length),h=g-d)=>{if(e)while(a[d])e=++e*g+f($.indexOf(a[d++]));else if(h?a>=0:![e=$.repeat([++a])])do{e=$[(b=(g-d*g+h*a)/(h*d))%g]+e;d*=g}while(g<=b);return e},r=0n,[c,d,e,g,h,m,o,q]=b?a.map(a=>i(a,1)+1n):Array(8).fill(r))=>{if(b)for(r++,l=l=>{l=!!(c&r)<<7|!!(d&r)<<6|!!(e&r)<<5|!!(g&r)<<4|!!(h&r)<<3|!!(m&r)<<2|!!(o&r)<<1|!!(q&1n);r<<=1n;q>>=1n;return l};q-1n;y+=String.fromCodePoint(p>>7?((j=l())>>7&&l())|((p&n)<<7|j&n)<<(j>>7&&7):p))p=l();else{l=a.length;for(b=j=0;l;q|=(z&1n)<<r++){j?j&=j>n&&n:(l--,j=(y=a[p](b++))>>7)>>9&&(l--,b++);z=f((j?(j>>7||j)|128:y&n));c|=(z&128n?1n:0n)<<r;d|=(z&64n?1n:0n)<<r;e|=(z&32n?1n:0n)<<r;g|=(z&16n?1n:0n)<<r;h|=(z&8n?1n:0n)<<r;m|=(z&4n?1n:0n)<<r;o|=(z&2n?1n:0n)<<r}y=[--c,--d,--e,--g,--h,--m,--o,(q|1n<<r)-1n].map(a=>i(a))}return y};
